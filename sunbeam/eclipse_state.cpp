...
void sunbeam::export_EclipseState(py::module& module) {
    ...
    py::class_< EclipseState >( module, "EclipseState" )
        ...
        .def( "_schedule",      &EclipseState::getSchedule)
        .def( "_props",         &EclipseState::get3DProperties)
        .def( "_grid",          &EclipseState::getInputGrid)
        .def( "_cfg",           &EclipseState::cfg)
        .def( "_tables",        &EclipseState::getTableManager)
        .def( "has_input_nnc",  &EclipseState::hasInputNNC )
        .def( "simulation",     &EclipseState::getSimulationConfig)
        .def( "summary",        &EclipseState::getSummaryConfig)
